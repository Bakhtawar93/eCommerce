            ...
            <table class="w-full">
              ...
              <tbody>
                ...
                <tr wire:key={{ $item['product_id'] }}>
                    ...
                    <td class="py-4">
                      <div class="flex items-center">
                        <button wire:click="decreateQty({{ $item['product_id'] }})" class="border rounded-md py-2 px-4 mr-2">-</button>
                        <span class="text-center w-8">{{ $item['quantity'] }}</span>
                        <button wire:click="increateQty({{ $item['product_id'] }})" class="border rounded-md py-2 px-4 ml-2">+</button>
                      </div>
                    </td>
                    ...
                    <td>
                        ...
                        <span wire:loading wire:target="removeItem({{ $item['product_id'] }})">Removing...</span></button>
                    </td>
                  </tr>
